...
describe("style value", () => {
  ...
  it("decoration", () => {
    const { asFragment } = render(
      <Textarea
        render={createRegexRenderer([[/ore/g, { textDecoration: "undeline" }]])}
        value={"Lorem ipsum dolor sit amet"}
        onChange={NOP}
      />
    );
  ...
  it("background", () => {
    const { asFragment } = render(
      <Textarea
        render={createRegexRenderer([[/ore/g, { background: "red" }]])}
        value={"Lorem ipsum dolor sit amet"}
        onChange={NOP}
      />
    );
...
describe("match", () => {
  it("match one", () => {
    const { asFragment } = render(
      <Textarea
        render={createRegexRenderer([[/ipsum/g, { color: "red" }]])}
        value={"Lorem ipsum dolor sit amet"}
        onChange={NOP}
      />
    );
  ...
  it("match many", () => {
    const { asFragment } = render(
      <Textarea
        render={createRegexRenderer([[/[or]/g, { color: "red" }]])}
        value={"Lorem ipsum dolor sit amet"}
        onChange={NOP}
      />
    );
  ...
  it("japanese", () => {
    const { asFragment } = render(
      <Textarea
        render={createRegexRenderer([[/[あ-ん]/g, { background: "yellow" }]])}
        value={
