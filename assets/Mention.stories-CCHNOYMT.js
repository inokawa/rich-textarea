import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{C as n}from"./iframe-ACcfL3a9.js";import{t as r}from"./react-dom-Dpm6uNYK.js";import{t as i}from"./jsx-runtime-O9QVJvLM.js";import{r as a,s as o,t as s}from"./src-CIrx2cL0.js";import{r as c,t as l}from"./mocks-CMKK5t8J.js";var u,d,f,p,m,h,g,_,v,y,b;t((()=>{u=e(n()),d=e(r()),s(),c(),f=i(),p={component:o},m={width:`400px`,height:`300px`},h=8,g=/\B@([\-+\w]*)$/,_=a([[RegExp(`(${l.map(e=>`@${e}`).join(`|`)})`,`g`),{background:`#EAF5F9`,color:`#4276AA`,borderRadius:`3px`}]]),v=({chars:e,index:t,top:n,left:r,complete:i})=>(0,f.jsx)(`div`,{style:{position:`fixed`,top:n,left:r,fontSize:`12px`,border:`solid 1px gray`,borderRadius:`3px`,background:`white`,cursor:`pointer`},children:e.map((e,n)=>(0,f.jsx)(`div`,{style:{padding:`4px`,...t===n&&{color:`white`,background:`#2A6AD3`}},onMouseDown:e=>{e.preventDefault(),i(n)},children:e},e))}),y={render:()=>{let e=(0,u.useRef)(null),[t,n]=(0,u.useState)(`Hi, @Captain Gregor and @Jaxxon . Please enter @ to show suggestions.

`),[r,i]=(0,u.useState)(null),[a,s]=(0,u.useState)(0),c=r?t.slice(0,r.caret):t,p=(r&&c.match(g))?.[1]??``,y=(0,u.useMemo)(()=>l.filter(e=>e.toLowerCase().startsWith(p.toLowerCase())).slice(0,h),[p]),b=t=>{if(!e.current||!r)return;let n=y[t];e.current.setRangeText(`@${n} `,r.caret-p.length-1,r.caret,`end`),i(null),s(0)};return(0,f.jsxs)(`div`,{children:[(0,f.jsx)(o,{ref:e,style:m,onChange:e=>n(e.target.value),value:t,onKeyDown:e=>{if(!(!r||!y.length))switch(e.code){case`ArrowUp`:e.preventDefault(),s(a<=0?y.length-1:a-1);break;case`ArrowDown`:e.preventDefault(),s(a>=y.length-1?0:a+1);break;case`Enter`:e.preventDefault(),b(a);break;case`Escape`:e.preventDefault(),i(null),s(0);break;default:break}},onSelectionChange:e=>{e.focused&&g.test(t.slice(0,e.selectionStart))?(i({top:e.top+e.height,left:e.left,caret:e.selectionStart}),s(0)):(i(null),s(0))},children:_}),r&&(0,d.createPortal)((0,f.jsx)(v,{top:r.top,left:r.left,chars:y,index:a,complete:b}),document.body)]})}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  render: () => {
