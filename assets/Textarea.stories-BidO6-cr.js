import{j as t}from"./observer-ChNWUPNK.js";import{a}from"./index-CeHYjMkx.js";import{L as ee}from"./mocks-Di3JMOQr.js";import{R as o}from"./textarea-D05uwaBC.js";import{c as f,a as re}from"./index-C2wRtkz4.js";const xe={component:o},l={width:"600px",height:"400px"},c={render:()=>{const[r,n]=a.useState("Lorem ipsum");return t.jsx(o,{style:l,onChange:e=>n(e.target.value),value:r,children:e=>e.split("").map((u,s)=>t.jsx("span",{style:{color:s%2===0?"red":void 0},children:u},s))})}},i={render:()=>t.jsx(o,{style:l,defaultValue:"Lorem ipsum",children:r=>r.split("").map((n,e)=>t.jsx("span",{style:{color:e%2===0?"red":void 0},children:n},e))})},ne=f([[/[A-Z][A-Z]+/g,{borderRadius:"3px",backgroundColor:"blue",color:"white"}],[/[A-Z][A-x]+/g,{color:"blue"}],[/[!?]+/g,{textDecoration:"underline wavy",color:"red"}],[/(but|and|so|also)+/g,{textDecoration:"line-through",color:"green"}],[/[0123456789]+/g,{color:"violet",fontWeight:"bold"}]]),d={render:()=>{const[r,n]=a.useState(`This is just a TEXTAREA but bit rich!!!
