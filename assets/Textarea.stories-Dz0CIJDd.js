import{j as t}from"./jsx-runtime-LTdcGt0a.js";import{r as a}from"./iframe-Cl4hEd6m.js";import{L as ee}from"./mocks-Di3JMOQr.js";import{R as o}from"./textarea-njaAF5CD.js";import{c as f,a as re}from"./index-D3P2RQUb.js";import"./observer-DAOSdsVF.js";const he={component:o},l={width:"600px",height:"400px"},c={render:()=>{const[r,n]=a.useState("Lorem ipsum");return t.jsx(o,{style:l,onChange:e=>n(e.target.value),value:r,children:e=>e.split("").map((u,s)=>t.jsx("span",{style:{color:s%2===0?"red":void 0},children:u},s))})}},i={render:()=>t.jsx(o,{style:l,defaultValue:"Lorem ipsum",children:r=>r.split("").map((n,e)=>t.jsx("span",{style:{color:e%2===0?"red":void 0},children:n},e))})},ne=f([[/[A-Z][A-Z]+/g,{borderRadius:"3px",backgroundColor:"blue",color:"white"}],[/[A-Z][A-x]+/g,{color:"blue"}],[/[!?]+/g,{textDecoration:"underline wavy",color:"red"}],[/(but|and|so|also)+/g,{textDecoration:"line-through",color:"green"}],[/[0123456789]+/g,{color:"violet",fontWeight:"bold"}]]),d={render:()=>{const[r,n]=a.useState(`This is just a TEXTAREA but bit rich!!!
...
12345`);return t.jsx(o,{style:l,onChange:a.useCallback(e=>n(e.target.value),[]),value:r,children:ae})}},h={render:()=>{const[r,n]=a.useState("Lorem ipsum");return t.jsx(o,{style:{width:600},onChange:e=>n(e.target.value),value:r,rows:1,autoHeight:!0})}},g={render:()=>{const[r,n]=a.useState(`אחד !
two !
...
}`,...(Y=(Q=b.parameters)==null?void 0:Q.docs)==null?void 0:Y.source}}};const ge=["Controlled","Uncontrolled","Style","CSSHighlight","OneLineAutoHeight","Rtl","WidthMax","BorderBox","Emoji","Search","Many"];export{m as BorderBox,x as CSSHighlight,c as Controlled,T as Emoji,b as Many,h as OneLineAutoHeight,g as Rtl,v as Search,d as Style,i as Uncontrolled,p as WidthMax,ge as __namedExportsOrder,he as default};
